package com.tools.assetmanagement.api.interceptor

import com.tools.assetmanagement.BuildConfig
import com.tools.assetmanagement.utils.LogUtil.showHttpApiLog
import com.tools.assetmanagement.utils.LogUtil.showHttpHeaderLog
import com.tools.assetmanagement.utils.LogUtil.showHttpLog
...
class LoggingInterceptor : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        var api = httpUrl.toString().replace(BuildConfig.API_DOMAIN, "")
        if (api.contains("?")) {
